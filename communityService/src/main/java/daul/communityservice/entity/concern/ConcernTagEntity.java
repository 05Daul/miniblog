...
import daul.communityservice.entity.project.ProjectTagId;
...
@NoArgsConstructor
@AllArgsConstructor
@Table(name="concern_tags")
public class ConcernTagEntity {
  @EmbeddedId
  @AttributeOverrides({
  ...
  private ConcernTagId concernTagId;

  @ManyToOne(fetch = FetchType.LAZY)
  @MapsId("communityId")
  @JoinColumn(name = "community_id")
  private ConcernEntity concernEntity;
